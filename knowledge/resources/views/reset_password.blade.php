...
<div class="container" style="margin-top: 130px; margin-left:410px; ">
  <div class="row ">
                    ...
                    action="{{ url('setNewPassword') }}">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group" style="display:none;">
                           <input type="text" class="form-control" placeholder="Password" name="token" value="{{$token}}" >
                       </div>
                         ...
                         <div>
                           ...
                           value="{{$email}}" class="form-control" style="display:none;">

                        </div>

                      </div>
                      <div class="form-group">
                        <input class="btn btn-lg  btn-block" value="Reset Password" type="submit" onclick="validatePassword()" style="background-color: #4CAF50;">
                      </div>
